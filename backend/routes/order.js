...
router.post("/create-order" , createOrder)  //reminder adding middle ware(authenticateuser) for getting userID

//get all orders by userId
router.get("/get-orders" , getOrdersByUserId)   //reminder adding middle ware(authenticateuser) for getting userID

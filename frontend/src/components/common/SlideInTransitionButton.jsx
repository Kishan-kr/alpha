...
export default function SlideInTransitionButton({
  ...
  return (
    <button
      className={`relative inline-block w-fit mx-auto overflow-hidden py-3 px-6 text-sm font-semibold uppercase tracking-widest text-dark border border-light bg-light group ${className}`}
      {...props}
    >
      {/* Text + Icon */}

      ...
      >
        ...
        {step === SEND_OTP && (
          <>
            {/* First name */}
            <div className="mb-10">
              <label htmlFor='firstName' className="block text-xxs text-border uppercase tracking-wider mb-2">First Name</label>
              <input
                type="text"
                id='firstName'
                name="firstName"
                ...
                className="w-full pb-2 border-b border-border bg-light text-sm outline-none text-subtext"
              />
            </div>

            {/* Last name */}
            <div className="mb-10">
              <label htmlFor='lastName' className="block text-xxs text-border uppercase tracking-wider mb-2">Last Name <span className='normal-case'>(optional)</span></label>
              <input
                type="text"
                id='lastName'
                maxLength={60}
            ...
            >
              {phoneStatus === LOADING ? <span className='animate-spin'><LoaderCircle className='w-5 h-5' /></span> : "Create Account"}
            </button>

            <p className="text-sm text-subtext mt-8 text-center">
              Already have an account?{' '}
              <Link to="/login" className="text-dark underline hover:text-accent">
                Log in
              </Link>
            </p>
          </>
